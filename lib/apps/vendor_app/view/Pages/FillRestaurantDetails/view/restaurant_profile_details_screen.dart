...
import '../controller/restaurant_profile_details_controller.dart';

class ResProfileDetailsScreen extends StatefulWidget {
  const ResProfileDetailsScreen({super.key});

  @override
  State<ResProfileDetailsScreen> createState() => _ResProfileDetailsScreenState();
}
...
class _ResProfileDetailsScreenState extends State<ResProfileDetailsScreen> {
  ...
  GetBuilder<ResProfileDetailsDetailsController> _profileImagePicker(
