...
import '../../../../menu/model/vendor_menu_model.dart' as product_model;
...
class VendorEditMenuController extends GetxController {
  ...
  final VendorMenuController restaurantMenuController = Get.isRegistered<VendorMenuController>() ? Get.find<VendorMenuController>() : Get.put(VendorMenuController());
