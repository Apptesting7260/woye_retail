...
class ChooseVendorCategoriesScreen extends StatelessWidget {
  ChooseVendorCategoriesScreen({super.key});

  final VendorCategoriesController controller = Get.find<VendorCategoriesController>();
