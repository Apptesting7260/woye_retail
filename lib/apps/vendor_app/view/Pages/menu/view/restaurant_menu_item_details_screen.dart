...
import '../../Products/Sub_screen/EditProduct/controller/restaurant_edit_menu_controller.dart';
import '../controller/restaurant_menu_item_details_controller.dart';

class RestaurantMenuItemDetailsScreen
    extends GetView<RestaurantMenuItemDetailsController> {
  const RestaurantMenuItemDetailsScreen({super.key});
