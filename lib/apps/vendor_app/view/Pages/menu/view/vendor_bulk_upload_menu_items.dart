...
//               hBox(2),
//               Text(
//                 "Upload a CSV file with your store items to add multiple items at once.",
//                 maxLines: 3,
...
//             onPressed: () {
//               if (controller.validateCsv()) {
//                 // TODO: wire up bulk upload API when ready
//               }
//             },
...
//                           CustomElevatedButton(
//                             borderSide:
//                                 BorderSide(color: AppColors.borderClr),
...
//         border: Border.all(
//             color: AppColors.borderClr.withAlpha(200), width: 1),
//         borderRadius: BorderRadius.circular(10),
