        ...
        children: [
          ...
          CustomElevatedButton(
            ...
            onPressed: () {
              ...
              child: Text("Clear All", style:  AppFontStyle.text_17_600(AppColors.black, fontFamily: AppFontFamily.gilroyMedium,)),
          ),
          ),
          wBox(14),
              ...
              children: [
                ...
                Column(
                  ...
                  children: group.items?.map((item) {
                    final isChecked = controller.selectedAttributeIds.contains(item.id.toString()).obs;
                    ...
                    return Padding(
                      ...
                      child: CustomCheckboxTile(
                        ...
                        onChanged: (v) {
                          isChecked.value = v;
                          if (v) {
                            if (item.id != null && !controller.selectedAttributeIds.contains(item.id.toString())) {
                              controller.selectedAttributeIds.add(item.id.toString());
                            }
                          } else {
                            controller.selectedAttributeIds.remove(item.id.toString());
                          }
