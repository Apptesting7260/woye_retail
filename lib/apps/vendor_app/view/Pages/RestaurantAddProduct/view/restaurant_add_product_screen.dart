                ...
                switch (restaurantProductAddController.rxRequestCategoryStatus.value) {
                  ...
                  case ApiStatus.COMPLETED:
                    return SingleChildScrollView(
                      controller:
                          restaurantProductAddController.scrollController,
                      child: Padding(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(
                    () => CustomDropDownApi(
                      selectedValue:
                          restaurantProductAddController.status.value,
                      items: statusItems,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    "Condition", style: AppFontStyle.text_14_500(AppColors.lightBlackClr, fontFamily: AppFontFamily.interMedium,),),
                  hBox(5),
                  CustomTextFormField(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    "Order Preparation Time", style: AppFontStyle.text_14_500(AppColors.lightBlackClr, fontFamily: AppFontFamily.interMedium,)),
                  hBox(5.h),
                  CustomTextFormField(
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Category", style: AppFontStyle.text_14_500(AppColors.lightBlackClr, fontFamily: AppFontFamily.interMedium,),
                      ),
                      hBox(5),
                      Obx(() => CustomDropDownApi(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Sub Category",
                        style: AppFontStyle.text_14_500(AppColors.lightBlackClr, fontFamily: AppFontFamily.interMedium,
                        ),
                      ),
                      hBox(5),
                      Obx(() => CustomDropDownApi(
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Screen Size", style: AppFontStyle.text_14_500(AppColors.lightBlackClr, fontFamily: AppFontFamily.interMedium,)),
                      hBox(5.h),
                      CustomTextFormField(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Ram", style: AppFontStyle.text_14_500(AppColors.lightBlackClr, fontFamily: AppFontFamily.interMedium,),),
                      hBox(5.h),
                      CustomTextFormField(
            ...
            children: [
                              ...
                              children: [
                                Text(
                                  ...
                                  style: AppFontStyle.text_12_500(
                                    selected ? AppColors.white : AppColors.black, fontFamily: AppFontFamily.interMedium,
                                  ),
                                ),
                                if (selected) ...[
                                  SizedBox(width: 5),
                              ...
                              child: Column(
                                ...
                                hBox(6),
                                  if (index != 0)
                                    GestureDetector(
                                      onTap: () =>
                                          controller.removeCustomAttributeField(index),
                                      child: Row(
                                        children: [
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                runSpacing: 8,
                                children: [
                                  ...controller.attributeValues[attr]!
                                      .map((val) {
                                    return AppContainer(
                                      padding: EdgeInsets.symmetric(
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(6),
                                      border: Border.all(
                                          color: AppColors.borderClr), color: Colors.white,
                                    ),
                                    child: TextField(
              ...
              Obx(() {
                ...
                final tableAttributes = controller.selectedVariantAttributes
                    .where((attr) => attr == "Storage" || attr == "RAM")
                    .toList();
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        AppContainer(
                          ...
                          child: Text("Apply Base Price to All",style: AppFontStyle.text_14_500(
                            AppColors.lightBlackClr, fontFamily: AppFontFamily.interMedium,),),
                        ),
                      ],
                    ),
                  ...
                  if (restaurantProductAddController.image.value != null)
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          if (restaurantProductAddController.image.value !=
                              null) {
              ...
              GestureDetector(
                ...
                child: DottedBorder(
                  ...
                  child: ClipRRect(
                    borderRadius: const BorderRadius.all(Radius.circular(12)),
                    child: Obx(() {
                      final imageFile = restaurantProductAddController
      ...
      return Row(
        children: [
          ...
          CustomElevatedButton(
              ...
              height: 45.h,
              width: 150.w,
              isLoading: restaurantProductAddController.rxRequestStatus.value ==
                  ApiStatus.LOADING,
              onPressed: () async {
                bool hasError = false;

                restaurantProductAddController.publishButtonKey.currentState
                    ?.validate();
                restaurantProductAddController.addOnButtonKey.currentState
                    ?.validate();

                bool isAllValidate = true;
                for (GlobalKey<FormState> key
                    in restaurantProductAddController.indexedKey) {
                ...
                if (restaurantProductAddController.titleController.value.text
                        .trim()
                        .isEmpty ||
                    !isValidCharacters(restaurantProductAddController
                        .titleController.value.text)) {
                  restaurantProductAddController
                      .scrollToField(restaurantProductAddController.titleKey);
                  return;
                }

                if (restaurantProductAddController.selectedCategoryId.value
                    .trim()
                    .isEmpty) {
                  restaurantProductAddController.scrollToField(
                      restaurantProductAddController.categoryKey);
                  return;
                }
                ...
                if (restaurantProductAddController.selectedCuisineType.value
                    ...
                    .isEmpty) {
                  restaurantProductAddController
                      .scrollToField(restaurantProductAddController.cuisineKey);
                  return;
                }
                ...
                if (restaurantProductAddController.selectedMenuSection.value
                    ...
                    .isEmpty) {
                  restaurantProductAddController.scrollToField(
                      restaurantProductAddController.menuSectionKey);
                  return;
                }
                ...
                if (restaurantProductAddController
                    ...
                    !isValidCharacters(restaurantProductAddController
                        .regularPriceController.value.text) ||
                    ((double.tryParse(restaurantProductAddController
                    ...
                    ((double.tryParse(restaurantProductAddController
                        ...
                        0)) {
                  restaurantProductAddController
                      .scrollToField(restaurantProductAddController.regularKey);
                  return;
                }
                ...
                if (restaurantProductAddController
                        ...
                        .trim()
                        .isEmpty ||
                    !RegExp(r'^\d{1,3}-\d{1,3}(min|hr|hrs)$',
                            caseSensitive: false)
                        .hasMatch(restaurantProductAddController
                            .preparationController.value.text
                            .trim())) {
                  restaurantProductAddController.scrollToField(
                      restaurantProductAddController.preparationKey,
                      allignment: 0.02);
                  return;
                }
                ...
                if (restaurantProductAddController
                    ...
                    restaurantProductAddController
                        ...
                        20) {
                  restaurantProductAddController.scrollToField(
                      restaurantProductAddController.descriptionKey);
                  return;
                }
                ...
                for (int optionIndex = 0;
                    optionIndex <
                        restaurantProductAddController.sizeConfigs.length;
                    optionIndex++) {
                  final configs =
                      restaurantProductAddController.sizeConfigs[optionIndex];
                ...
                final formState =
                    restaurantProductAddController.addOnFormKey.currentState;

                if (formState == null || !formState.validate()) {
                  for (int i = 0;
                      i < restaurantProductAddController.addOnFieldKeys.length;
                      i++) {
                    final fieldMap =
                        restaurantProductAddController.addOnFieldKeys[i];
                    ...
                    final priceController =
                        restaurantProductAddController.addOnPriceControllers[i];
                    final selectedIds =
                        restaurantProductAddController.selectedAddOnIds;
                ...
                await restaurantProductAddController.restaurantAddProductApi(
                  productTitle:
                      restaurantProductAddController.titleController.value.text,
                  categoryId:
                      restaurantProductAddController.selectedCategoryId.value,
                  status: restaurantProductAddController.status.value == "1"
                      ? "active"
                      : "inActive",
                  regularPrice: restaurantProductAddController
                      .regularPriceController.value.text,
                  salePrice: restaurantProductAddController
                      .salePriceController.value.text,
                  description: restaurantProductAddController
                      .descriptionController.value.text,
                  cuisineType:
                      restaurantProductAddController.selectedCuisineType.value,
                  mainImage: restaurantProductAddController.imageBase64.value,
                  image0: restaurantProductAddController
                      .additionalImageBase64[0].value,
                  image1: restaurantProductAddController
                      .additionalImageBase64[1].value,
                  image2: restaurantProductAddController
                      .additionalImageBase64[2].value,
                  image3: restaurantProductAddController
                      .additionalImageBase64[3].value,
                );
              },
              text: "Save Product",
