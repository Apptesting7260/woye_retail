...
class RestaurantTncScreen extends StatefulWidget {
  const RestaurantTncScreen({super.key});

  @override
  State<RestaurantTncScreen> createState() => _RestaurantTncScreenState();
}

class _RestaurantTncScreenState extends State<RestaurantTncScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      header(
                        ...
                        description:controller.loginType.value == "grocery" ? "Terms of service for grocery store management platform" : "Terms of service for restaurant management platform",
                      ),
                      Divider(color: AppColors.borderClr, height: 30),
                      (controller.apiData.value.termsAndConditions?.isEmpty ?? false) ?
                       CustomNoResultFound(heightBox: hBox(0),) :
                      Text(controller.format(controller.apiData.value.termsAndConditions?.toString() ?? ""),
                          maxLines: 2000,
