  ...
  Widget build(BuildContext context) {
    ...
    return DropdownButtonFormField2<String>(
      ...
      decoration:  InputDecoration(
        filled: true,
        fillColor:filledClr ?? AppColors.filledClr.withAlpha(150),
...
,
      ...
      validator: validator,
      hint: Text(hintText ?? 'Select an option', style: hintStyle ?? AppFontStyle.text_16_400(AppColors.black, fontFamily: AppFontFamily.gilroyMedium,),),
      ...
      items: items.map((item) => DropdownMenuItem<String>(
          ...
          child: Text(isTitle != null && isTitle == true ? item.title ?? '' : item.name ?? '',
            style: textStyle ?? AppFontStyle.text_14_400(AppColors.black, fontFamily: AppFontFamily.gilroyMedium,),
    ...
    Widget build(BuildContext context) {
      ...
      return DropdownButtonFormField2<String>(
        ...
        decoration: InputDecoration(
          ...
          labelText: labelText ?? '',
          contentPadding:
          contentPadding ?? REdgeInsets.symmetric(vertical: 15, horizontal: 10),
          focusedErrorBorder: OutlineInputBorder(
            borderSide: borderSide ?? BorderSide.none,
            borderRadius: BorderRadius.all(Radius.circular(borderRadius ?? 15.r)),
          ),
        ...
        items: items
            ...
            enabled: selectedValues == null
                ? true
                : !selectedValues!.contains(item.id),
            value: item.id,
            child: Text(
              isTitle == true ? (item.title ?? '') : (item.name ?? ''),
              style: textStyle ??
