...
import 'package:gyaawa/presentation/common/home_address/controller/select_delivery_address_controller.dart';
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: GestureDetector(
                  onTap: () => controller.selectedIndex.value = index, // ✅ FIX
                  child: Container(
                    width: double.infinity,
                    padding: const EdgeInsets.all(14),
                    decoration: BoxDecoration(
