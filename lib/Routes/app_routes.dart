...
import 'package:gyaawa/presentation/common/tab_bar/sub_screen/view/editor_choice_screen.dart';
import 'package:gyaawa/presentation/common/tab_bar/sub_screen/view/featured_screen.dart';
import 'package:gyaawa/presentation/common/tab_bar/sub_screen/view/gift_screen.dart';
...
class AppRoutes {
  ...
  static List<GetPage> pages = <GetPage>[
    ...
    GetPage(name: selectDeliveryAddress, page: () =>  SelectDeliveryAddress()),
